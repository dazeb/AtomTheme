<template>
    <div class="bg-slate-900">
        <div class="container m-auto mx-auto grid grid-cols-3 gap-4 bg-slate-900">
            <a class="block rounded-xl border border-gray-800 bg-gray-900 p-4 shadow-xl sm:p-6 lg:p-8" href="">
...
export default {
    data() {
        return {
            ...
            // Add other data properties for new input fields
        };
    },
    methods: {
        handleSubmit() {
