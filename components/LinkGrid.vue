<template>
    <section class="bg-white dark:bg-gray-900 dark:text-white">
        <div class="mx-auto max-w-screen-xl px-4 py-4 sm:py-6 sm:px-6 lg:py-16 lg:px-8">
            ...
            <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                <a class="block rounded-xl border border-gray-300 dark:border-gray-800 p-8 shadow-xl transition hover:border-blue-500/10 hover:shadow-primary-500/20 dark:hover:border-blue-500/20 dark:hover:shadow-primary-500/20"
                    ...
                    <Icon name="💎" size="24" />
                    <h2 class="mt-4 text-xl font-bold text-gray-900 dark:text-gray-300">Digital campaigns</h2>
